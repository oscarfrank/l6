<?php
/*
 * Contact form + branch phone/email list (FR3).
 * Validation is on the server; JS is optional. We don't call mail()
 * (out of scope) so success is a confirmation on the page.
 * Offer / flight / hotel cards can arrive with a drafted message in GET.
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // No mail() in this phase. Show confirmation and which branch they picked.
    if (!$errors) {
        foreach ($branches as $row) {
